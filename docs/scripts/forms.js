const vf = 3.003; // prettier-ignore
...
function typeSort(a, b) {
	...
	if (a === "melf") return -1;
	if (b === "melf") return 1;
	if (a === "dynaMinsc") return -1;
	if (b === "dynaMinsc") return 1;
	if (a === "mimoHeir") return -1;
	if (b === "mimoHeir") return 1;
	return 0;
}
